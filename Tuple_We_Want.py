...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --runUnscheduled --mc --filein root://eoscms//eos/cms/store/user/mshi/heavyHiggs_300_light_9_2mu2tau_sim/heavyHiggs_300_light_9_2mu2tau_sim_NUM.root --conditions 76X_mcRun2_asymptotic_v12 -n 300 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://eoscms//eos/cms/store/user/mshi/gg2H2aa2mumutautau_19GeV_step2/gg2H2aa2mumutautau_19GeV_step2_1.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('miniAOD-prod nevts:300'),
